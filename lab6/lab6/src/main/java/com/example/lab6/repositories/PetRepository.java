...
public interface PetRepository extends JpaRepository<Pet, Integer> {
    ...
    @Query("SELECT new com.example.lab6.dtos.PetNameBreedAnimalType(p.name, p.animalType, p.breed) FROM Pet p")
    List<com.example.lab6.dtos.PetNameBreedAnimalType> findAllPetNameBreedAnimalType();
